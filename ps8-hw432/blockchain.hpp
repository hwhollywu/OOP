// ----------------------------------------------------------
// Blockchain class for Problem Set 8.			blockchain.hpp
// Author: Hao Wu 
// Date: Dec 7, 2018.
// -----------------------------------------------------------
...
public:
    ...
    Block* tail() const {return sp.getTarget();}
    // returns the length of current blockchain.
    unsigned length() const {return sp.getTarget()->blkLevel(); } 
	//---------------------------------- Function Prototypes
	Blockchain extend();
	ostream& print(ostream& out) const;
	bool operator==(Blockchain &bc2);
    bool operator<(const Blockchain &bc2) const;
};
